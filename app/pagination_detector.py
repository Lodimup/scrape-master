...
def detect_pagination_elements(
    url: str, indications: str, selected_model: str, markdown_content: str
) -> Tuple[Union[PaginationData, Dict, str], Dict, float]:
    try:
        """
        ...
        prompt_pagination = (
            PROMPT_PAGINATION
            + "\n The url of the page to extract pagination from   "
            + url
        ...
        if selected_model in ["gpt-4o-mini", "gpt-4o-2024-08-06"]:
            ...
            logging.info(f"Gemini Flash response type: {
